...
export class MapService {
  ...
  constructor(private http: Http, private timeService: TimeService, private snackBar: MatSnackBar) { }
    ...
    const gpxLayer = omnivore.gpx(_map.gpx, null, null)
      .on('ready', (data) => {
        ...
        try {       
          ...
          this.snackBar.open('Parece que hubo un problema, por favor recargue la página', '', {duration: 5000});
        }
      }).addTo(map);
